...
export const AI_TOOLS = [
  ...
  { value: 'stable-diffusion',  label: 'Stable Diffusion',  color: '#3b82f6', icon: '◈' },
...
export const detectDimensions = (file) =>
  new Promise((resolve) => {
    ...
    img.onload = () => {
      ...
      const r = w / h
      const orientation = r > 1.15 ? 'landscape' : r < 0.87 ? 'portrait' : 'square'
      // detect aspect ratio
      ...
      const aspectRatio = best && minDiff / best.ratio < 0.04 ? best.value : `${w}:${h}`
