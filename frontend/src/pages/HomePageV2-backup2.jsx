  ...
  return (
    <div className="min-h-screen overflow-x-hidden pj" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      >
        ...
        {/* Hero background collage — angled grid như template */}
        <div className="absolute inset-0 -z-10 opacity-25 overflow-hidden">
          <div className="grid grid-cols-4 gap-4 rotate-12 scale-125 translate-y-16 w-full h-full">
            {[
              'https://images.unsplash.com/photo-1557682224-5b8590cd9ec5?w=400&q=70',
              'https://images.unsplash.com/photo-1518020382113-a7e8fc38eac9?w=400&q=70',
              'https://images.unsplash.com/photo-1534796636912-3b95b3ab5986?w=400&q=70',
              ...
              <div key={i} className={`rounded-2xl overflow-hidden border border-white/5
                ${i % 2 === 0 ? 'h-80' : 'h-96 -translate-y-16'}`}>
        ...
        >
          ...
          <motion.h1
            ...
            className="text-6xl sm:text-7xl md:text-8xl lg:text-[8rem] font-black
              tracking-tighter leading-[1.05] mb-8"
          >
            <span className="block text-white">Chia sẻ sáng tạo,</span>
            <span className="block shimmer-text">Kiếm tiền từ đam mê</span>
          </motion.h1>
      ...
      <section className="py-24 px-4 relative overflow-hidden">
        ...
        >
          ...
          <div className="relative rounded-[2.5rem] overflow-hidden p-12 md:p-20
            bg-gradient-to-br from-violet-600 via-blue-600 to-indigo-700 noise">
            {/* White/dark blobs */}
            <div className="absolute top-0 right-0 w-96 h-96 bg-white/15 rounded-full blur-[100px] pointer-events-none" />
            <div className="absolute bottom-0 left-0 w-64 h-64 bg-black/30 rounded-full blur-[80px] pointer-events-none" />

            <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-16">
              {/* Left text */}
              <div className="max-w-xl text-center lg:text-left">
                <p className="text-white/60 text-sm font-bold tracking-widest uppercase mb-4 pj">
                  🚀 Creator Program
                </p>
                ...
                <p className="text-white/75 text-lg mb-8 leading-relaxed pj">
                ...
                <div className="flex items-center justify-center lg:justify-start gap-5 mb-8">
                  <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/20 text-center">
                    ...
                    <div className="text-[10px] font-bold uppercase text-white/55 pj">Lượt thích</div>
                  </div>
                  <div className="text-white text-2xl font-black pj">=</div>
                  <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/20 text-center">
                    <div className="text-2xl font-black text-white pj">5 Xu</div>
                    <div className="text-[10px] font-bold uppercase text-white/55 pj">Coin</div>
                  </div>
                </div>
              </div>

              {/* Right: PRO card */}
              <div className="liquid-glass-strong rounded-2xl p-8 max-w-sm w-full border border-white/20">
                ...
                <ul className="space-y-4 mb-8">
                  {[
                    ...
                    <li key={item} className="flex items-center gap-3 text-sm text-white/85 pj">
                      <div className="w-5 h-5 rounded-full bg-blue-400/20 border border-blue-400/40
                ...
                <Link to="/register">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.97 }}
                    className="w-full py-4 bg-white text-violet-700 font-black rounded-full pj
