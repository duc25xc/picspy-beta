...
const Header = () => {
  ...
  return (
    ...
    >
      <div className="max-w-[1692px] mx-auto px-8 h-full flex items-center justify-between">
        {/* Logo */}
        ...
        <nav className="flex items-center gap-2">
          <Link to="/" className="btn-ghost px-4 py-1.5 rounded-full text-sm font-medium transition-colors">
            {t.nav.explore}
          </Link>
          <Link to="/search" className="btn-ghost px-4 py-1.5 rounded-full text-sm font-medium transition-colors">
            {t.nav.search}
          </Link>
          <Link to="/pricing" className="btn-ghost px-4 py-1.5 rounded-full text-sm font-medium transition-colors">
            {t.nav.pricing}
          </Link>
          {user && (
            <Link to="/my-posts" className="btn-ghost px-4 py-1.5 rounded-full text-sm font-medium flex items-center gap-1.5 transition-colors">
              <LayoutGrid size={14} />
              {t.nav.myPosts}
            </Link>
          )}
        ...
        {user ? (
          <div className="flex items-center gap-4">
            ...
            {/* Action Buttons */}
            <Link to="/upload" className="btn-primary px-4 py-1.5 h-9 rounded-full flex items-center gap-1.5 font-semibold text-xs transition-all shadow-md">
              <Upload size={14} />
          ...
          <div className="flex items-center gap-2">
            <Link to="/login" className="btn-ghost px-4 py-1.5 rounded-full text-sm font-semibold transition-colors">
              {t.nav.login}
            </Link>
            <Link to="/register" className="btn-primary px-4 py-1.5 h-9 rounded-full flex items-center font-semibold text-xs transition-all shadow-md">
              {t.nav.register}
            </Link>
          </div>
        )}
