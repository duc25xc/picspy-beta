...
const MONGODB_URI = 'mongodb+srv://picspy:picspy@duc25xc.cepmcvt.mongodb.net/?appName=duc25xc'
...
const sampleWorkflow = JSON.stringify({
  ...
  '6': {
    inputs: { text: (post.prompt || 'a beautiful scene').slice(0, 120), clip: ['4', 1] },
    class_type: 'CLIPTextEncode',
    _meta: { title: 'Positive Prompt' }
  },
  '7': {
    inputs: { text: 'ugly, blurry, low quality, watermark, deformed', clip: ['4', 1] },
    class_type: 'CLIPTextEncode',
